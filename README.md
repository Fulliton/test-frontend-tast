...
<p>
    <h1 align="center">Тестовое задание на логику</h1>
    <br>
</p>

> После пуша в ваш репозиторий, сделайте задание в любой другой ветке и PR в основную.  
> Предпрочтительнее использовать Angular или Vue
